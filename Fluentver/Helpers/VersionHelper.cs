...
namespace Fluver.Helpers
{
    public static class VersionHelper
    {
        ...
        /// <summary>
        /// Gets the current <see cref="InsiderChannel"/> installed on the system.
        /// </summary>
